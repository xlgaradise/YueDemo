    ...
    private MyExceptionHandler(Context cxt) {
        ...
        if (isSdcardMounted()) {
            LOG_FILE_PATH = Environment.getExternalStorageDirectory()
                    + File.separator+"MyAppLogs"+File.separator + "uncaughtException.txt";
        } else {

            LOG_FILE_PATH = File.separator+"data"+File.separator+"data" +File.separator
                    + "MyAppLogs"+File.separator + "uncaughtException.txt";
        }
    }
